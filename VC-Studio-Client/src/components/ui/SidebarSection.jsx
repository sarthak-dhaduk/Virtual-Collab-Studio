...
const SidebarSection = ({ title, links, isWorkspace, isOpen, toggleSection }) => {
    return (
        <div className="sidebar-section">
            ...
            >
                ...
                {isWorkspace && (
                    <button
                        className="gradient-button text-uppercase fw-semibold" data-bs-toggle="modal"
            ...
            <ul className="section-list"
                ...
                {isWorkspace && (
                    <li className="">
                        <button
                            className="btn-create-workspace" data-bs-toggle="modal"
